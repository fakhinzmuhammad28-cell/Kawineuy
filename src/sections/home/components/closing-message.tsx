    ...
    >
      <div className="max-w-4xl mx-auto text-center">
        <motion.div
          ...
          className="mb-12"
        >
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-5xl font-serif text-gray-800 mb-6">
        ...
        >
          <p className="text-lg sm:text-xl md:text-2xl lg:text-2xl text-gray-700 leading-relaxed mb-6 font-light">
        ...
        >
          ...
          <p className="text-sm sm:text-base text-gray-600">
            #ALifeWithNida #CintaDalamRidhaAllah #MenujuSakinahBersama
          </p>
        </motion.div>
        ...
        >
          <p className="text-xs sm:text-sm text-gray-500">
            Mau dibuatkan undangan digital menarik?, Silahkan Hubungi saya : alfakh28@gmail.com / 082319210105 
          </p>
        </motion.div>
      </div>
    </div>
